...
public class ExprLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "IMPORT", "PUBLIC", "PRIVATE", "CLASS", "STATIC", "NEW", "VOID", 
			"INT", "IF", "SYSOUT", "SCAN", "WHILE", "DO", "ELSE", "SWITCH", "GET", 
			"SET", "STRING", "DOUBLE", "BOOLEAN", "ARRAY", "ARRAYLIST", "LIST", "FLOAT", 
			"NUM", "CADENA", "ID", "IGUAL", "SUMA", "MAYORIGUAL", "AND", "OR", "PUNTO", 
			"PUNTO_COMA", "PAR_IZQ", "PAR_DER", "LLAVE_IZQ", "LLAVE_DER", "COR_IZQ", 
			"COR_DER", "WS"
		};
	}
